...
namespace RFIDApi.controller
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        public SalesController(RFIDDbContext db, IHubContext<RFIDHubs> hubContext, IServiceScopeFactory scopeFactory)
        {
            _context = db;
        ...
        [HttpGet("GetSalesDaily")]
        public async Task<IActionResult> GetSalesDaily()
        {
            try
            {
                var data = await _context.shopifySalesDailies.ToListAsync();
